...
public class MoreCullingSodiumConfigBuilder implements ConfigEntryPoint {
    ...
    private static final ResourceLocation LEAVES_CULLING = ResourceLocation.parse("moreculling:leaves_culling");
    private static final ResourceLocation BLOCK_STATE = ResourceLocation.parse("moreculling:block_state_culling");
    private static final ResourceLocation ITEM_RENDERER = ResourceLocation.parse("moreculling:custom_item_frame_renderer");
    private static final ResourceLocation ITEM_3F_CULLING = ResourceLocation.parse("moreculling:item_frame_3_face_culling");
    private static final ResourceLocation ITEM_LOD = ResourceLocation.parse("moreculling:item_frame_lod");
    ...
    public void registerConfigLate(ConfigBuilder builder) {
        ...
        builder.registerOwnModOptions()
                .setIcon(ResourceLocation.parse("moreculling:moreculling.png"))
                .addPage(builder.createOptionPage()
                        .setName(Component.translatable("moreculling.config.category.general"))
                        .addOptionGroup(builder.createOptionGroup()
                                // Rain/Snow Culling
                                .addOption(
                                        builder.createBooleanOption(ResourceLocation.parse("moreculling:rain_culling"))
                                ...
                                // Cloud Culling
                                .addOption(
                                        builder.createBooleanOption(ResourceLocation.parse("moreculling:cloud_culling"))
                                ...
                                // Sign Text Culling
                                .addOption(
                                        builder.createBooleanOption(ResourceLocation.parse("moreculling:sign_text_culling"))
                                ...
                                // Beacon Beam Culling
                                .addOption(
                                        builder.createBooleanOption(ResourceLocation.parse("moreculling:beacon_beam_culling"))
                                ...
                                // BlockStates
                                .addOption(
                                        builder.createBooleanOption(ResourceLocation.parse("moreculling:block_state_culling"))
                                ...
                                .addOption(
                                        builder.createBooleanOption(ResourceLocation.parse("moreculling:end_gateway_culling"))
                        ...
                        .addOptionGroup(builder.createOptionGroup()
                                ...
                                .addOption(
                                        builder.createBooleanOption(ResourceLocation.parse("moreculling:item_frame_map_culling"))
                                ...
                                .addOption(
                                        builder.createIntegerOption(ResourceLocation.parse("moreculling:item_frame_lodrange"))
                                ...
                                .addOption(
                                        builder.createIntegerOption(ResourceLocation.parse("moreculling:item_frame_3_face_culling_range"))
                        ...
                        .addOptionGroup(builder.createOptionGroup()
                                ...
                                .addOption(
                                        builder.createIntegerOption(ResourceLocation.parse("moreculling:leaves_culling_amount"))
                                ...
                                .addOption(
                                        builder.createBooleanOption(ResourceLocation.parse("moreculling:include_mangrove_roots"))
