...
public class IntSliderControl implements Control<Integer> {
    ...
    public IntSliderControl(Option<Integer> option, int min, int max, int interval, Component text) {
    ...
    private static class Button extends ControlElement<Integer> {
        ...
        public Button(Option<Integer> option, Dim2i dim, int min, int max, int interval, String text) {
            super(option, dim);
